<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="SealTravels.AddUser" %>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                <div class="col-lg-5 d-none d-lg-block bg-gradient-primary">
                                    <h1 style="font-weight: 700; margin-left: 70px; margin-top: 100px; color: white">Seal Travels <i class="fa fa-globe-americas"></i></h1>
                                </div>
                                <div class="col-lg-7">
                                    <div class="p-5">
                                        <div class="">
                                            <h4 class="" style="color: #4e73df; font-family: Heebo"><strong>Add User</strong> <i class="fa fa-user-plus"></i></h4>
                                            <br />
                                        </div>
                                        ...
                                        <form runat="server" class="user">
                                            ...
                                            <div class="form-group">
                                                <input id="email" runat="server" class="form-control" type="text" placeholder="Email" required="required" style="font-size: 13px" />
                                            </div>

                                            <div class="form-group">
                                                <input id="username" runat="server" class="form-control" type="text" placeholder="Username" required="required" style="font-size: 13px" />
                                            </div>

                                            <div class="form-group">
                                                <input id="password" runat="server" class="form-control" type="password" visible="false" placeholder="Password" required="required" style="font-size: 13px" />
                                            </div>

                                            <div class="form-group">
                                                <input id="date" runat="server" class="form-control" type="text" placeholder="Date" onfocus="(this.type='date')" required="required" style="font-size: 13px" />
                                            </div>

                                            <div>
                                                <asp:Button ID="addusers" runat="server" Text="ADD USER" CssClass="btn btn-primary btn-block" OnClick="addusers_Click" Font-Bold="true" Font-Size="13px" />
                                            </div>
