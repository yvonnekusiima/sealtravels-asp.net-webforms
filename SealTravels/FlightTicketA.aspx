...
<body style="font-family: Heebo">
    ...
    <div class="container">
        ...
        <form runat="server" style="text-align: center">
            <asp:Button ID="printticket" runat="server" Text="PRINT TICKET" CssClass="btn btn-primary" Font-Size="13px" Font-Bold="true" />
            <asp:Button ID="saveticket" runat="server" Text="SAVE TICKET" CssClass="btn btn-primary" Font-Size="13px" Font-Bold="true" />
        </form>
        <br />
    </div>
