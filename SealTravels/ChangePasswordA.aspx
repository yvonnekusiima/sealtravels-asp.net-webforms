<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePasswordA.aspx.cs" Inherits="SealTravels.ChangePasswordA" %>
                        ...
                        <li class="nav-item dropdown no-arrow d-sm-none">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <input runat="server" id="administratorid2" class="mr-2 d-none d-lg-inline text-gray-600 small" readonly="readonly" style="border: none; outline: none; text-align: right" />
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="p-5">
                                        <div class="">
                                            <h4 class="" style="color: #4e73df; font-family: Heebo"><strong>Change Password</strong> <i class="fa fa-edit"></i></h4>
                                            <br />
                                        </div>
                                        ...
                                        <form runat="server" class="user">
                                            ...
                                            <div class="form-group">
                                                <input runat="server" id="administratorid" class="form-control" placeholder="Administrator Id" required="required" style="font-size: 13px" />
                                            </div>

                                            <div class="form-group">
                                                <input runat="server" id="currentpassword" class="form-control" type="password" placeholder="Current Password" required="required" style="font-size: 13px" />
                                            </div>

                                            <div class="form-group">
                                                <input runat="server" id="newpassword" class="form-control" type="password" placeholder="New Password" required="required" style="font-size: 13px" />
                                            </div>

                                            <div class="form-group">
                                                <asp:Button ID="changepassword" runat="server" Text="SAVE CHANGES" CssClass="btn btn-primary btn-block" OnClick="changepassword_Click" Font-Bold="true" Font-Size="13px" />
                                            </div>
