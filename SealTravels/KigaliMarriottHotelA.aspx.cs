...
{
    public partial class KigaliMarriottHotelA : System.Web.UI.Page
    {
        ...
        protected void bookroom_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(s))
                {
                    ...
                    cmd_al.Parameters.AddWithValue("@Action", "Made hotel booking at Kigali Marriott Hotel");
                    ...
                    Response.Redirect("HotelRecordsA.aspx");
                }
            }
            catch (Exception ex)
            {
