<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HotelBookingU.aspx.cs" Inherits="SealTravels.HotelBookingU" %>
                        ...
                        <v class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="TheMonarchHotelU.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="MestilHotelU.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align: center; font-size: 100px"></i>
                                            <div class="card-body" style="text-align: center; font-weight: bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="TheOberoiU.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align: center; font-size: 100px"></i>
                                            <div class="card-body" style="text-align: center; font-weight: bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="KigaliMarriottHotelU.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align: center; font-size: 100px"></i>
                                            <div class="card-body" style="text-align: center; font-weight: bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="EkoHotelU.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align: center; font-size: 100px"></i>
                                            <div class="card-body" style="text-align: center; font-weight: bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="LagoonHotelU.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align: center; font-size: 100px"></i>
                                            <div class="card-body" style="text-align: center; font-weight: bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="Shangri-laHotelU.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align: center; font-size: 100px"></i>
                                            <div class="card-body" style="text-align: center; font-weight: bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="HotelBrusselsU.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align: center; font-size: 100px"></i>
                                            <div class="card-body" style="text-align: center; font-weight: bold">
