                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView CssClass="table-hover table-bordered results" ID="flightticketrecords" runat="server" ForeColor="#4e73df" Font-Size="13px" AutoGenerateColumns="false" DataKeyNames="Id">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="passengername" HeaderText="Passenger Name" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="status" HeaderText="Status" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="travelclass" HeaderText="Travel Class" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="from" HeaderText="From" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="to" HeaderText="To" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="flight" HeaderText="Flight" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="seat" HeaderText="Seat" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="checkin" HeaderText="Check-in" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="gate" HeaderText="Gate" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="date" HeaderText="Date" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="barcode" HeaderText="Barcode" HeaderStyle-Font-Bold="true" />
