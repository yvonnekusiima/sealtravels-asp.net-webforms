<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePasswordU.aspx.cs" Inherits="SealTravels.ChangePasswordU" %>
                        ...
                        <li class="nav-item dropdown no-arrow d-sm-none">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <input runat="server" id="username2" class="mr-2 d-none d-lg-inline text-gray-600 small" readonly="readonly" style="border: none; outline: none; text-align: right" />
                                    ...
                                    <div class="p-5">
                                        ...
                                        <form runat="server" class="user">
                                            ...
                                            <div class="form-group">
                                                <input runat="server" id="username" class="form-control" placeholder="Username" required="required" style="font-size: 13px" />
                                            </div>
