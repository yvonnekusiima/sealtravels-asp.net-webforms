<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnewayBookingU.aspx.cs" Inherits="SealTravels.OnewayBookingU" %>
                                                ...
                                                <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>Book a Oneway flight</strong> <i class="fa fa-plane"></i></h4><br />
                                                        ...
                                                        <form runat="server" class="user">
                                                            ...
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                ...
                                                                <input runat="server" id="triptype" class="form-control" value="Oneway" readonly="readonly" style = "font-size: 13px;" />
                                                            </div>
                                                            ...
                                                            <!--Book-->
                                                            <div>
                                                                <asp:Button ID="bookflight" runat="server" OnClick="bookflight_Click" Text="BOOK FLIGHT" CssClass="btn btn-primary btn-block"  Font-Bold="true" />
                                                            </div>
