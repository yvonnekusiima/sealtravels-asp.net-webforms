<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlightTicketRecordsU.aspx.cs" Inherits="SealTravels.FlightTicketRecordsU" %>
...
<body style="font-family:Heebo">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="OnewayRecordsU.aspx">Oneway flight records</a>
    ...
    <form runat="server">
       ...
       <div class="card shadow mb-4 my-2">
            ...
            <asp:GridView CssClass="table-hover table-bordered results" ID="" runat="server"  ForeColor="#4e73df" Font-Size="13px" AutoGenerateColumns="false" DataKeyNames="Id">
                <Columns>
