                                ...
                                <div class="row">
                                    ...
                                    <form runat="server" class="user">
                                        ...
                                        <!--Payment Method-->
                                            ...
                                            <div class="form-check float-left" style="color: #4e73df; font-weight: bold; ">
                                                <input type="radio" runat="server" id="visacard" class="" style = "font-size: 13px;" /> Visa Card
                                            </div>
                                            <div class="form-check float-left" style="color: #4e73df; font-weight: bold; ">
                                                <input type="radio" runat="server" id="americanexpress" class="" style = "font-size: 13px;" /> American Express
                                            </div>
                                            <div class="form-check float-left" style="color: #4e73df; font-weight: bold; ">
                                                <input type="radio" runat="server" id="mastercard" class="" style = "font-size: 13px;" /> Master Card
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group">
                                            <asp:Button runat="server" ID="submitpayment" Text="SUBMIT PAYMENT" Cssclass="btn btn-primary btn-block"  Font-Bold="true" OnClick="submitpayment_Click"></asp:Button>
                                        </div>
