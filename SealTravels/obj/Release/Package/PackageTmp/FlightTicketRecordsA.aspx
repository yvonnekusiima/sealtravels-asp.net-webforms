<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlightTicketRecordsA.aspx.cs" Inherits="SealTravels.FlightTicketRecordsA" %>
...
<head runat="server">
    ...
    <title>Flight Ticket Records</title>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="FlightTicketRecordsA.aspx">Flight Ticket records</a>
    ...
    <form runat="server">
       ...
       <div class="card shadow mb-4 my-2">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Flight Tickets</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">

                  <div class="form-group">
                        <input class="search pull-left" placeholder="Search for ticket" style="font-size:13px" />
                      <span class="counter pull-right"></span>
                    </div>

            <asp:GridView CssClass="table-hover table-bordered results" ID="flightticketrecords" runat="server"  ForeColor="#4e73df" Font-Size="13px" AutoGenerateColumns="false" DataKeyNames="Id">
                <Columns>
                    <asp:BoundField DataField="id" HeaderText="Id" HeaderStyle-Font-Bold="true" Visible="false" />
                    <asp:BoundField DataField="passengername" HeaderText="Passenger Name" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="travelclass" HeaderText="Travel Class" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="from" HeaderText="From" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="to" HeaderText="To" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="flight" HeaderText="Flight" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="seat" HeaderText="Seat" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="checkin" HeaderText="Check-in" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />                                 
                    <asp:BoundField DataField="gate" HeaderText="Gate" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />                                 
                    <asp:BoundField DataField="date" HeaderText="Date" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />                                 
                    <asp:BoundField DataField="barcode" HeaderText="Barcode" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />                                 
