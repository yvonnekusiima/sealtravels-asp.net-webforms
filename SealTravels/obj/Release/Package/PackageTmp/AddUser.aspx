                                            ...
                                            <div class="">
                                                <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>Add User</strong> <i class="fa fa-user-plus"></i></h4><br />
                                                            ...
                                                            <form runat="server" class="user">
                                                                ...
                                                                <div class="form-group"><input id="email" runat="server" class="form-control" type="text" placeholder="Email" required="required" style="font-size:13px" /></div>
                
                                                                <div class="form-group"><input id="username" runat="server" class="form-control" type="text" placeholder="Username" required="required" style="font-size:13px" /></div>               
                                                                
                                                                <div class="form-group"><input id="password" runat="server" class="form-control" type="password" visible="false" placeholder="Password" required="required" style="font-size:13px" /></div>

                                                                <div class="form-group"><input id="date" runat="server" class="form-control" type="text" placeholder="Date" onfocus="(this.type='date')" required="required" style="font-size:13px" /></div>               
                                                                
                                                                <div><asp:Button ID="addusers" runat="server" Text="ADD USER" CssClass="btn btn-primary btn-block" OnClick="addusers_Click" Font-Bold="true" /></div>
