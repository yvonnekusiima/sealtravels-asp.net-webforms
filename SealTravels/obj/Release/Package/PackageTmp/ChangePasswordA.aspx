                                            ...
                                            <div class="">
                                                <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>Change Password</strong> <i class="fa fa-edit"></i></h4><br />
                                                             ...
                                                             <form runat="server" class="user">
                                                                ...
                                                                <div class="form-group"><input runat="server" id="administratorid" class="form-control" placeholder="Administrator Id" required="required" style="font-size:13px" /></div>

                                                                <div class="form-group"><input runat="server" id="currentpassword" class="form-control" type="password" placeholder="Current Password" required="required" style="font-size:13px" /></div>

                                                                <div class="form-group"><input runat="server" id="newpassword" class="form-control" type="password" placeholder="New Password" required="required" style="font-size:13px" /></div>

                                                                <div class="form-group"><asp:Button ID="changepassword" runat="server" Text="SAVE CHANGES" CssClass="btn btn-primary btn-block" OnClick="changepassword_Click"  Font-Bold="true" /></div>
