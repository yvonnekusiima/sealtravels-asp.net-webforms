<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KigaliMarriottHotelU.aspx.cs" Inherits="SealTravels.KigaliMarriottHotelU" %>
                                                ...
                                                <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>Book a Hotel</strong> <i class="fa fa-hotel"></i></h4><br />
                                                        ...
                                                        <form runat="server" class="user">
                                                            ...
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                ...
                                                                <input runat="server" id="hotelname" class="form-control" placeholder="Kigali Marriott Hotel" readonly="readonly" style = "font-size: 13px;" />
                                                            </div>
