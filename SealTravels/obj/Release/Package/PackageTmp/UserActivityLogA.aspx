<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserActivityLogA.aspx.cs" Inherits="SealTravels.UserActivityLogA" %>
            ...
            <div class="card-body">
              <div class="table-responsive">
                  ...
                  <div class="form-group">
                        <input class="search pull-left" placeholder="Search for user activity" style="font-size:13px" />
                      <span class="counter pull-right"></span>
                    </div>

            <asp:GridView CssClass="table-hover table-bordered results" ID="useractivitylog" runat="server"  Font-Size="13px" AutoGenerateColumns="false">
                <Columns>
