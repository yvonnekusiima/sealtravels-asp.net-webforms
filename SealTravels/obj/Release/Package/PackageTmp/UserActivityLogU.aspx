<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserActivityLogU.aspx.cs" Inherits="SealTravels.UserActivityLogU" %>
...
<body style="font-family:'Proxima Nova'">
    ...
    <form runat="server">
        ...
        <div class="card shadow mb-4 my-2">
            ...
            <asp:GridView CssClass="table-hover table-bordered results" ID="useractivitylog" runat="server" Font-Size="13px" Font-Size="13px" AutoGenerateColumns="false">
                <Columns>
