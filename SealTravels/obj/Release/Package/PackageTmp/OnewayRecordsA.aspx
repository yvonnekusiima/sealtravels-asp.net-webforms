<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnewayRecordsA.aspx.cs" Inherits="SealTravels.OnewayRecordsA" %>
    ...
    <form runat="server">
      ...
      <div class="card shadow mb-4 my-2">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Oneway flights</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">

                  <div class="form-group">
                        <input class="search pull-left" placeholder="Search for flight" style="font-size:13px" />
                      <span class="counter pull-right"></span>
                    </div>

            <asp:GridView CssClass="table-hover table-bordered results" ID="onewayrecords" runat="server"  Font-Size="13px" AutoGenerateColumns="false" DataKeyNames="Id" OnPageIndexChanging="onewayrecords_PageIndexChanging" OnRowCancelingEdit="onewayrecords_RowCancelingEdit" OnRowDeleting="onewayrecords_RowDeleting" OnRowEditing="onewayrecords_RowEditing" OnRowUpdating="onewayrecords_RowUpdating">
                <Columns>
                    <asp:BoundField DataField="id" HeaderText="Id" HeaderStyle-Font-Bold="true" Visible="false" />                    
                    <asp:BoundField DataField="name" HeaderText="Name" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="email" HeaderText="Email" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="contact" HeaderText="Contact" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="triptype" HeaderText="TripType" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="leavingfrom" HeaderText="Leaving From" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="goingto" HeaderText="Going To" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="departing" HeaderText="Departing" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="adults" HeaderText="Adults" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="children" HeaderText="Children" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" /> 
                    <asp:BoundField DataField="flighttype" HeaderText="Flight Type" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="airline" HeaderText="Airline" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="travelclass" HeaderText="Travel Class" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="amount" HeaderText="Amount" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
