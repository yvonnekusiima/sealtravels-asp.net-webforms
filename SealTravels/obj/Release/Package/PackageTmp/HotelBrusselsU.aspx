<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HotelBrusselsU.aspx.cs" Inherits="SealTravels.HotelBrusselsU" %>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon rotate-n-0">
                    <img src="../../Assets/img/globe2.png" width="50" height="50" />
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../RoundtripBooking.aspx">Book Roundtrip flight</a>
                        <a class="collapse-item" href="../OnewayBooking.aspx">Book Oneway flight</a>
                        <a class="collapse-item" href="../Records/RoundtripRecords.aspx">Roundtrip flight records</a>
                        <a class="collapse-item" href="../Records/OnewayRecords.aspx">Oneway flight records</a>
                        <a class="collapse-item" href="../Records/FlightTicketRecords.aspx">Flight Tickets records</a>
                        <a class="collapse-item" href="../Records/FlightPaymentRecords.aspx">Flight Payment records</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Select</h6>
                        <a class="collapse-item" href="../HotelBooking.aspx">Book a hotel</a>
                        <a class="collapse-item" href="../Records/HotelRecords.aspx">Update a hotel booking</a>
                        <a class="collapse-item" href="../Records/HotelRecords.aspx">Hotel Booking records</a>
                    </div>
                </div>
            </li>
                                                ...
                                                <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>Book a Hotel</strong> <i class="fa fa-hotel"></i></h4><br />
                                                        ...
                                                        <form runat="server" class="user">
                                                            ...
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                ...
                                                                <input runat="server" id="hotelname" class="form-control" placeholder="Hotel Brussels" readonly="readonly" style = "font-size: 13px;" />
                                                            </div>
                                                            ...
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                ...
                                                                <input runat="server" id="checkin" class="form-control" placeholder="" type="datetime-local" style = "font-size: 13px;" />
                                                            </div>

                                                            <!--Check Out-->
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                <label style = "width: 150px;color: #4e73df;font-weight: bold;font-size: 13px">CheckIn</label>
                                                                <input runat="server" id="checkout" class="form-control" placeholder="" type="datetime-local" style = "font-size: 13px;" />
                                                            </div>
                                                                </div>

                                                            <!--Book-->
                                                            <div>
                                                                <asp:Button ID="bookroom" runat="server" Text="BOOK ROOM" CssClass="btn btn-primary btn-block"  Font-Bold="true" Width="200px" />
                                                            </div>
