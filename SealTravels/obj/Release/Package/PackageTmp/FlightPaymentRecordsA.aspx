<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlightPaymentRecordsA.aspx.cs" Inherits="SealTravels.FlightPaymentRecordsA" %>
       ...
       <div class="card shadow mb-4 my-2">
            ...
            <asp:GridView CssClass="table-hover table-bordered results" ID="flightpaymentrecords" runat="server"  ForeColor="#4e73df" Font-Size="13px" AutoGenerateColumns="false" DataKeyNames="Id">
                <Columns>
                    ...
                    <asp:BoundField DataField="paymentmethod" HeaderText="Payment Method" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="cardnumber" HeaderText="Card Number" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="cvv" HeaderText="CVV" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="expirydate" HeaderText="Expiry Date" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
