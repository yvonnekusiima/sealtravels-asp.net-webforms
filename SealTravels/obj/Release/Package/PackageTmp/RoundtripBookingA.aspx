<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoundtripBookingA.aspx.cs" Inherits="SealTravels.RoundtripBookingA" %>
                                                ...
                                                <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>Book a Roundtrip flight</strong> <i class="fa fa-plane"></i></h4><br />
                                                        ...
                                                        <form runat="server" class="user">
                                                            ...
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                ...
                                                                <input runat="server" id="departing" class="form-control" placeholder="" type="datetime-local" style = "font-size: 13px;" />
                                                            </div>
                                                            ...
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                ...
                                                                <input runat="server" id="returning" class="form-control" placeholder="" type="datetime-local" style = "font-size: 13px;" />
                                                            </div>
                                                                </div>
                                                            ...
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                ...
                                                                <input runat="server" id="triptype" class="form-control" value="Roundtrip" readonly="readonly" style = "font-size: 13px;" />
                                                            </div>
                                                            ...
                                                            <!--Book-->
                                                            <div>
                                                                <asp:Button ID="bookflight" OnClick="bookflight_Click" runat="server" Text="BOOK FLIGHT" CssClass="btn btn-primary btn-block"  Font-Bold="true" />
                                                            </div>
