<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TheOberoiA.aspx.cs" Inherits="SealTravels.TheOberoiA" %>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="row">
                                    <div class="col-lg-5 d-none d-lg-block bg-gradient-primary">
                                        <h1 style="font-weight:700; margin-left:100px; margin-top:180px; color:white">The Oberoi</h1>
                                    </div>
                                    <div class="col-lg-7">
                                        <div class="p-5">
                                            <div class="">
                                                <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>Book a Hotel</strong> <i class="fa fa-hotel"></i></h4><br />
                                                        ...
                                                        <form runat="server" class="user">
                                                            ...
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                ...
                                                                <input runat="server" id="hotelname" class="form-control" placeholder="The Oberoi" readonly="readonly" style = "font-size: 13px;" />
                                                            </div>
                                                            ...
                                                            <!--Book-->
                                                            <div>
                                                                <asp:Button ID="bookroom" runat="server" OnClick="bookroom_Click" Text="BOOK ROOM" CssClass="btn btn-primary btn-block"  Font-Bold="true" />
                                                            </div>
