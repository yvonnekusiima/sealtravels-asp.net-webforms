<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="SealTravels.UserLogin" %>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <div class="form-group">
                                <input id="username" runat="server" class="form-control" placeholder="Username" required="required" style="font-size:13px" />
                                <ASP:RequiredFieldValidator ControlToValidate="username" Display="None" ErrorMessage="*" runat="server" ID="validateusername" />
                            </div>
                            ...
                            <div class="form-group">
                                <asp:Button ID="login" runat="server" CssClass="btn btn-primary btn-block" Text="LOGIN"  OnClick="login_Click" Font-Bold="true" />
                            </div>
