<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HotelRecordsU.aspx.cs" Inherits="SealTravels.HotelRecordsU" %>
        ...
        <div class="card shadow mb-4 my-2">
            ...
            <asp:GridView CssClass="table-hover table-bordered results" ID="hotelrecords" runat="server" Font-Size="13px" AutoGenerateColumns="false" DataKeyNames="Id" OnPageIndexChanging="hotelrecords_PageIndexChanging" OnRowCancelingEdit="hotelrecords_RowCancelingEdit" OnRowDeleting="hotelrecords_RowDeleting" OnRowEditing="hotelrecords_RowEditing" OnRowUpdating="hotelrecords_RowUpdating">
                <Columns>
                    ...
                    <asp:BoundField DataField="travelers" HeaderText="Travelers" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="rooms" HeaderText="Rooms" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="roomtype" HeaderText="RoomType" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="checkin" HeaderText="Check In" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
                    <asp:BoundField DataField="checkin" HeaderText="Check Out" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="false" />
