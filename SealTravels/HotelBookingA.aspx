<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HotelBookingA.aspx.cs" Inherits="SealTravels.HotelBookingA" %>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="photo-gallery" style="background-color: transparent;">
                        ...
                        <v class="container">
                            <div class="intro">
                                <h2 class="text-center" style="padding-top: 0px; font-weight: bold">HOTELS <i class="fa fa-hotel" style="margin-left: 5px"></i></h2>
                                <br />
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="TheMonarchHotelA.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="MestilHotelA.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align: center; font-size: 100px"></i>
                                            <div class="card-body" style="text-align: center; font-weight: bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="TheOberoiA.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align: center; font-size: 100px"></i>
                                            <div class="card-body" style="text-align: center; font-weight: bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="KigaliMarriottHotelA.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align: center; font-size: 100px"></i>
                                            <div class="card-body" style="text-align: center; font-weight: bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="EkoHotelA.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align: center; font-size: 100px"></i>
                                            <div class="card-body" style="text-align: center; font-weight: bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="LagoonHotelA.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align: center; font-size: 100px"></i>
                                            <div class="card-body" style="text-align: center; font-weight: bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="Shangri-laHotelA.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align: center; font-size: 100px"></i>
                                            <div class="card-body" style="text-align: center; font-weight: bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="HotelBrusselsA.aspx" style="text-decoration: none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align: center; font-size: 100px"></i>
                                            <div class="card-body" style="text-align: center; font-weight: bold">
