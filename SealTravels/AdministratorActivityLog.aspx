<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdministratorActivityLog.aspx.cs" Inherits="SealTravels.AdministratorActivityLog" %>
                    ...
                    <form runat="server">
                        ...
                        <div class="card shadow mb-4 my-2">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Administrator Activity Log</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">

                                    <div class="form-group">
                                        <input class="search pull-left" placeholder="Search for activity" style="font-size: 13px" />
                                        <span class="counter pull-right"></span>
                                    </div>

                                    <asp:GridView CssClass="table-hover table-bordered results" ID="administratoractivitylog" runat="server" Font-Size="13px" AutoGenerateColumns="false">
                                        <Columns>
                                            <asp:BoundField DataField="administratorid" HeaderText="Administrator Id" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="datetimestamp" HeaderText="Date & Timestamp" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="action" HeaderText="Action" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="ipaddress" HeaderText="IP Address" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="hostname" HeaderText="Host Name" HeaderStyle-Font-Bold="true" />
                                        </Columns>
                                    </asp:GridView>
                                </div>
                            </div>
