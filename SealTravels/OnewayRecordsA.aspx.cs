...
{
    public partial class OnewayRecordsA : System.Web.UI.Page
    {
        ...
        protected void onewayrecords_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(s))
                {
                    ...
                    Session["PassengerName"] = name.Text;
                    Session["Email"] = email.Text;
                    Session["Contact"] = contact.Text;
                    Session["LeavingFrom"] = leavingfrom.Text;
                    Session["GoingTo"] = goingto.Text;
                    Session["TravelClass"] = travelclass.Text;
                    Session["Airline"] = airline.Text;
                    Server.Transfer("FlightTicketA.aspx");
                }
            }
            catch (Exception ex)
            {
