<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoundtripRecordsU.aspx.cs" Inherits="SealTravels.RoundtripRecordsU" %>
                        ...
                        <div class="card shadow mb-4 my-2">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView CssClass="table-hover table-bordered results" ID="roundtriprecords" runat="server" Font-Size="13px" AutoGenerateColumns="false" DataKeyNames="Id" OnPageIndexChanging="roundtriprecords_PageIndexChanging" OnRowCancelingEdit="roundtriprecords_RowCancelingEdit" OnRowDeleting="roundtriprecords_RowDeleting" OnRowEditing="roundtriprecords_RowEditing" OnRowUpdating="roundtriprecords_RowUpdating">
                                        <Columns>
