<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserRecords.aspx.cs" Inherits="SealTravels.UserRecords" %>
                        ...
                        <div class="card shadow mb-4 my-2">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <asp:GridView CssClass="table table-bordered text-center results" ID="dataTable" runat="server" UseAccessibleHeader="true" Font-Size="13px" AutoGenerateColumns="false" DataKeyNames="Id" OnPageIndexChanging="userrecords_PageIndexChanging" OnRowCancelingEdit="userrecords_RowCancelingEdit" OnRowDeleting="userrecords_RowDeleting" OnRowEditing="userrecords_RowEditing" OnRowUpdating="userrecords_RowUpdating">
                                        <Columns>
                                            <asp:BoundField DataField="id" HeaderText="Id" HeaderStyle-Font-Bold="true" Visible="false" />
                                            <asp:BoundField DataField="username" HeaderText="Username" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="email" HeaderText="Email" HeaderStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="dateadded" HeaderText="Date Added" HeaderStyle-Font-Bold="true" />
                                            <asp:CommandField HeaderText="Edit" ShowEditButton="true" ShowCancelButton="false" ControlStyle-CssClass="btn btn-primary" ControlStyle-Font-Size="13px" />
                                            <asp:CommandField HeaderText="Delete" ShowDeleteButton="true" ControlStyle-CssClass="btn btn-primary" ControlStyle-Font-Size="13px" />
                                        </Columns>
                                    </asp:GridView>
                                </div>
                            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="logout_modal_label">Ready to Leave?</h5>
